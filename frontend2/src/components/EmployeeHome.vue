<template>
  <section class="employee-dashboard">
    <header class="employee-title"><div><p class="eyebrow">My workday</p><h1>Good morning, Arjun.</h1><p>Everything you need for today, without the HR maze.</p></div><div class="date-callout"><Icon name="calendar" /><div><strong>Friday, 22 August</strong><span>Connaught Place Office</span></div></div></header>
...
const emit=defineEmits(["leave","toast"])
